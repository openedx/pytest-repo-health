# -*- coding: utf-8 -*-
#
# pytest-opynions documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-opynions Documentation',
     [author], 1)
]
